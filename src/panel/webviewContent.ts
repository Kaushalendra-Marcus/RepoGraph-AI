...
.tab-icon .icon-img,.btn-icon .icon-img,.inline-icon .icon-img,.empty-icon .icon-img{display:block;object-fit:contain}
.tab-icon .icon-img,.btn-icon .icon-img,.inline-icon .icon-img{transform:translateY(1px)}
.empty-icon .icon-img{width:36px;height:36px;transform:translateY(2px)}
.tab-icon .icon-img,.btn-icon .icon-img{width:14px;height:14px}
.inline-icon .icon-img{width:12px;height:12px}
body.vscode-dark .icon-img, body.vscode-high-contrast .icon-img{filter:invert(1) brightness(1.35) contrast(1.1)}
body.vscode-light .icon-img{filter:none}
...
<div id="tab-analyze" class="screen active">
  <div class="scroll">
    ...
    <div class="source-tabs">
      ...
      <button class="source-tab" id="src-github-btn" onclick="switchSource('github')"><span class="tab-icon" data-icon="github-url.svg"></span> GitHub URL</button>
    </div>
    ...
    <!-- GITHUB -->
    <div class="source-pane" id="pane-github">
      <label>GitHub Repository URL</label>
      <input id="repo-url" type="text" placeholder="https://github.com/owner/repo" style="margin-bottom:8px"/>
      <label>GitHub Token <span style="font-weight:400">(optional, for private repos)</span></label>
      <input id="github-token" type="password" placeholder="ghp_..." style="margin-bottom:10px"/>
      <button class="btn btn-block" id="github-analyze-btn" onclick="analyzeGithub()" style="margin-bottom:12px">
        <span class="btn-icon" data-icon="analyze-github.svg"></span> Analyze GitHub Repo
      </button>
      <label style="margin-top:4px">Quick examples</label>
      <button class="example-btn" onclick="setRepo('https://github.com/expressjs/express')">expressjs/express</button>
      <button class="example-btn" onclick="setRepo('https://github.com/fastapi/fastapi')">fastapi/fastapi</button>
      <button class="example-btn" onclick="setRepo('https://github.com/vuejs/vue')">vuejs/vue</button>
      <button class="example-btn" onclick="setRepo('https://github.com/pallets/flask')">pallets/flask</button>
    </div>
